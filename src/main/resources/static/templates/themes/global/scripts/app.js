/* Weather IP Location Widgets*/
       /*  var country_kode = "";
                $.getJSON("http://ip-api.com/json/208.80.152.201?callback=?", function(data) { //ubah parameter ip 
                   var data_city = data.city;
                   var data_country_kode = data.countryCode;
                 //$("#GeoResults").html(data_city + ", "+data_country_kode);
                 var oj = ""+data_city+", "+data_country_kode+""; 
