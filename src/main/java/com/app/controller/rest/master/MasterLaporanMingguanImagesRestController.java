...
@RestController
@RequestMapping("/rest/master/master_laporan_mingguan_images")
public class MasterLaporanMingguanImagesRestController {
    ...
    public ResponseListObject search(
        ...
        try {
            Page<LaporanMingguanImages> pageData = vs.SearchByLokasi(rows, page - 1, search, laporanId);
    ...
    public ResponseObject save(HttpServletRequest request, @RequestParam(value = "laporanId", required = true) String laporanId,
        ...
        ResponseObject<LaporanMingguanImages> response = new ResponseObject<LaporanMingguanImages>();
        try {
            LaporanMingguanImages k = new LaporanMingguanImages();
