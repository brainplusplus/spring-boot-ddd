 ...
 */
@RestController
@RequestMapping("/api/laporan_mingguan_images")
public class ApiLaporanMingguanImagesController {
    ...
    public ResponseListObject search(
        ...
        try {
            ...
            req.rows = rows;
            req.token = token;
            Page<LaporanMingguanImages> pageData = gls.getImageListByIdLokasi(req);
            if(pageData!=null){
