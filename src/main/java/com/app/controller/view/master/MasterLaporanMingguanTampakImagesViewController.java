...
@Controller
@RequestMapping("/admin/master/master_laporan_mingguan_tampak_images")
public class MasterLaporanMingguanTampakImagesViewController {
...
//		System.out.println("======================= print ===============");
	...
	public String form(@PathVariable("lm_id") String lmId,Model model) {
		...
		model.addAttribute("lokasi",lm.getIdLokasi().getAlamat());
		model.addAttribute("paket",lm.getIdLokasi().getIdPaket().getNamaPaket());
		return "partial/master/master_laporan_mingguan_tampak_images/form";
	}
}
