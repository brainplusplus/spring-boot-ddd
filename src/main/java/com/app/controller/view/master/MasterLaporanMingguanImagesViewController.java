...
@Controller
@RequestMapping("/admin/master/master_laporan_mingguan_images")
public class MasterLaporanMingguanImagesViewController {
...
//		System.out.println("======================= print ===============");
		...
		return "view/master/master_laporan_mingguan_images/index";
	}
	...
	public String form(@PathVariable("lm_id") String lmId,Model model) {
		...
		model.addAttribute("lokasi",lm.getIdLokasi().getAlamat());
		model.addAttribute("paket",lm.getIdLokasi().getIdPaket().getNamaPaket());
		return "partial/master/master_laporan_mingguan_images/form";
	}
}
