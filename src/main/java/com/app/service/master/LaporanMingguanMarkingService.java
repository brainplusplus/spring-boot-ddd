...
import com.app.dao.LaporanMingguanMarkingDao;
...
@Service
public class LaporanMingguanMarkingService extends GenericDAOService<LaporanMingguanMarkingDao, LaporanMingguanMarking> {

    @Autowired
    private LaporanMingguanMarkingDao vd;
    ...
    public Page<LaporanMingguanMarking> SearchByLokasi(int rows, int page, String search, String idLaporan) {

        PageRequest paginationRequest = new PageRequest(page, rows);
        Page<LaporanMingguanMarking> hasil = null;
    ...
    public LaporanMingguanMarking save(LaporanMingguanMarking k, String idLaporan, MultiPartObject file) {
        k.setId(UUID.randomUUID().toString());
        UploadImageObject gbrUpload = new UploadImageObject();
        if (file != null) {
            try {
                gbrUpload = au.saveImage(file.name, file.file);
    ...
    @Transactional(readOnly = false, rollbackFor = Exception.class)
    public LaporanMingguanMarking update(LaporanMingguanMarking k, String idLaporan, MultiPartObject file) throws IllegalAccessException, InvocationTargetException {
        LaporanMingguanMarking entity = (LaporanMingguanMarking) vd.findOne(k.getId());
    ...
    public List<LaporanMingguanMarking> findByIdLaporan(String IdLaporan) {
